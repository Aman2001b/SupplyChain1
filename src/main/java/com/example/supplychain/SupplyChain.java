...
public class SupplyChain extends Application {
    ...
    private GridPane loginPage(){
        ...
        gridPane.setVgap(10); // for vertical gap between items
        gridPane.setHgap(10); //for horizontal gap bw items
    ...
    public Pane createContent(){
        ...
        root.setPrefSize(width,height+2*upperLine);
